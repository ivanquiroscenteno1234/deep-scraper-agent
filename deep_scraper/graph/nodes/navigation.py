...
# Pre-lowercase indicators for performance (Bolt ⚡ optimization)
...
async def node_analyze_mcp(state: AgentState) -> Dict[str, Any]:
    ...
    # Bolt ⚡ Optimization:
    # Use pre-compiled lowercased indicators and single lowercased content string
    # to avoid repeated string allocation in loop.
