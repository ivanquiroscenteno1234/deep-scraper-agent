...
# Pre-compiled search indicators for performance
# Bolt ⚡ Optimization: Moved out of loop and pre-lowercased
_SEARCH_INDICATORS = [
    # AcclaimWeb patterns
...
async def node_analyze_mcp(state: AgentState) -> Dict[str, Any]:
    ...
    # Bolt ⚡ Optimization: Use pre-compiled lowercased indicators and single lower() call
