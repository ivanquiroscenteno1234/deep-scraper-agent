...
async def node_analyze_mcp(state: AgentState) -> Dict[str, Any]:
    ...
    # Get cleaned page content directly from browser (Bolt ⚡ Optimization)
    # This skips fetching massive raw HTML and cleaning it in Python
    page_content = await browser.get_cleaned_html(max_length=100000)
    raw_html = page_content  # Use cleaned content for fallback checks too
