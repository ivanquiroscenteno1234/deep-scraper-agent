...
# --- Pre-lowercased indicators for optimized search detection ---
_SEARCH_INDICATORS = [
    # AcclaimWeb patterns
...
async def node_analyze_mcp(state: AgentState) -> Dict[str, Any]:
    ...
    # BOLT ⚡ Optimization: Pre-lowercase content and indicators once to avoid
    # redundant work in the loop.
