...
# Bolt ⚡ Optimization: Pre-lowercase indicators to avoid repeated .lower() in loop
_SEARCH_INDICATORS = [
    # AcclaimWeb patterns
...
async def node_analyze_mcp(state: AgentState) -> Dict[str, Any]:
    ...
    # Bolt ⚡ Optimization: Call .lower() once on the large content string
    page_content_lower = page_content.lower()

    has_input_elements = '<input' in page_content_lower
    # Bolt ⚡ Optimization: Use pre-lowercased indicators and the lowered content
    has_search_indicators = any(indicator in page_content_lower for indicator in _SEARCH_INDICATORS)
